...
$_lang["contact"] = "Nous contactez";
$_lang["your.mail"] = "Votre adresse-mail";
$_lang["content"] = "Contenu du message";
$_lang["send"] = "Envoyer";
$_lang["contact.message.sent"] = "Merci de nous avoir contacté. Une réponse vous serra donné prochainement.";
$_lang["topic"] = "Sujet";
$_lang["contact.message.too.short"] = "Votre message est trop court. Un minimum de 10 charactères est requis.";
$_lang["contact.topic.too.short"] = "Le sujet de votre message est trop petit. Un minimum de 10 charactères est requis.";
$_lang["invalid.mail.forgot.password"] = "Nous n'avons pas trouvé de compte associé à cette adresse mail.";
$_lang["error.cannot.fetch.steam.api"] = "Nous n'avons pas pu récupérer vos données de profil Steam. Veuillez réesayer ultérieurement.Cannot get your steam profile data from steam. Try again later.";
